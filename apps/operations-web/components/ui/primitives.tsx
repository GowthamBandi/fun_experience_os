...
export const statusTone: Record<string, string> = {
  ...
  published: "text-[#9db4ff] bg-[#4c6fff]/12 border-[#4c6fff]/25",
  open: "text-[#5fd7a3] bg-[#12b76a]/12 border-[#12b76a]/25",
  "booking-open": "text-[#5fd7a3] bg-[#12b76a]/12 border-[#12b76a]/25",
  "almost-full": "text-[#ffc46b] bg-[#f79009]/12 border-[#f79009]/25",
  full: "text-[#ff8f86] bg-[#f04438]/12 border-[#f04438]/25",
  "booking-closed": "text-[#ffc46b] bg-[#f79009]/12 border-[#f79009]/25",
  "reveal-pending": "text-[#ffc46b] bg-[#f79009]/12 border-[#f79009]/25",
  revealed: "text-[#ffd28a] bg-[#f7b955]/14 border-[#f7b955]/30",
  "check-in-open": "text-[#5fd7a3] bg-[#12b76a]/12 border-[#12b76a]/25",
  ...
  completed: "text-[#5fd7a3] bg-[#12b76a]/12 border-[#12b76a]/25",
  archived: "text-ink-mut bg-white/4 border-white/6",
  cancelled: "text-[#ff8f86] bg-[#f04438]/12 border-[#f04438]/25",
  active: "text-[#5fd7a3] bg-[#12b76a]/12 border-[#12b76a]/25",
  reserved: "text-[#9db4ff] bg-[#4c6fff]/12 border-[#4c6fff]/25",
  "payment-pending": "text-[#ffc46b] bg-[#f79009]/12 border-[#f79009]/25",
  "payment-confirmed": "text-[#5fd7a3] bg-[#12b76a]/12 border-[#12b76a]/25",
  "payment-failed": "text-[#ff8f86] bg-[#f04438]/12 border-[#f04438]/25",
  "reservation-expired": "text-ink-mut bg-white/4 border-white/6",
  "waitlist-joined": "text-[#ffc46b] bg-[#f79009]/12 border-[#f79009]/25",
  "waitlist-promoted": "text-[#ffd28a] bg-[#f7b955]/14 border-[#f7b955]/30",
  complimentary: "text-[#9db4ff] bg-[#4c6fff]/12 border-[#4c6fff]/25",
  ...
  reported: "text-[#9db4ff] bg-[#4c6fff]/12 border-[#4c6fff]/25",
  triaged: "text-[#ffc46b] bg-[#f79009]/12 border-[#f79009]/25",
  escalated: "text-[#ff8f86] bg-[#f04438]/12 border-[#f04438]/25",
  monitoring: "text-[#ffc46b] bg-[#f79009]/12 border-[#f79009]/25",
